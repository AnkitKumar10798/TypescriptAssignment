        ...
        for (let c = 0; c < this.datalen; c++) {
            ...
            tr.innerHTML =
                '<td  class="cell' + c + '">' + Emp[c].firstName + '</td>' +
                    ...
                    '<td  class="cell' + c + '">' + Role[Emp[c].role] + '</td>' +
                    '<td  class="cell' + c + '">' + Emp[c].address + '</td>' +
                    '<td> <button type="button" class="btn btn-primary"    id="edit' + c + '"> edit </button></td>' +
                    '<td> <button type="button" class = "btn btn-primary"  id="delete' + c + '"> delete </button></td>';
    ...
    editData(row_num) {
        if (this.flag[row_num] === false) {
            ...
            for (index = 0; index < ele.length; index++) {
                if (index === 5) {
                    ele[index].innerHTML = Role[+ele[index].childNodes[0].value];
                }
                else {
